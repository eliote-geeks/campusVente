            ...
            <div className="swipe-container">
                ...
                <div className="action-buttons">
                    <button 
                        ...
                        onClick={() => console.log('Pass button clicked - DISABLED')}
                        aria-label="Passer"
                    >
                        <X size={20} />
                    </button>
                    ...
                    <button 
                        ...
                        onClick={() => console.log('Super like button clicked - DISABLED')}
                    ...
                    <button 
                        ...
                        onClick={() => console.log('Like button clicked - DISABLED')}
                        aria-label="Like"
                    >
                        <Heart size={20} />
                    </button>
