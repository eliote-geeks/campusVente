...
const CampusLoveMediaUploadBase64 = ({ 
    photos = [], 
    onPhotosChange, 
    maxPhotos = 6 
}) => {
    // Debug pour voir la structure des photos - DÉSACTIVÉ
    // console.log('CampusLove Photos reçues:', photos);
    ...
    const handleFiles = useCallback(async (files) => {
        ...
        for (const file of validFiles) {
            ...
            try {
                ...
                const response = await fetch('/api/v1/campus-love/photos/upload-base64', {
                    method: 'POST',
                    headers: {
                    ...
                    body: JSON.stringify({
                        photo_base64: base64,
                        is_profile_photo: photos.length === 0 // Première photo = photo de profil
                    })
                });
                ...
                if (data.success) {
                    // Récupérer les photos mises à jour de l'utilisateur
                    ...
                    if (userData.success && onPhotosChange) {
                        onPhotosChange(userData.data.dating_photos_base64 || []);
                    }
                } else {
    ...
    const handleDeletePhoto = async (photoIndex) => {
        ...
        try {
            ...
            // Créer une copie des photos sans celle à supprimer
            ...
            const response = await fetch('/api/v1/me', {
                ...
                body: JSON.stringify({
                    dating_photos_base64: newPhotos
                })
            });
    ...
    const handleSetProfilePhoto = async (photoIndex) => {
        ...
        try {
            // Marquer toutes les photos comme non-profil sauf celle sélectionnée
            const updatedPhotos = photos.map((photo, index) => ({
                ...photo,
                is_profile_photo: index === photoIndex
            }));
            ...
            const response = await fetch('/api/v1/me', {
                ...
                body: JSON.stringify({
                    dating_photos_base64: updatedPhotos
                })
            });
    ...
    const savePhotoMetadata = async () => {
        ...
        try {
            // Mettre à jour la photo avec les nouvelles métadonnées
            const updatedPhotos = photos.map((photo, index) => 
                    ...
                    >
                        <div className="drag-drop-content">
                            ...
                            <p className="text-muted">
                                ...
                                <small>JPEG, PNG, GIF - Maximum 10MB par photo - Stockage en base de données</small>
                            </p>
...
export default CampusLoveMediaUploadBase64;